...
export async function seed(knex) {
  ...
  await knex('requisitions').insert([
    ...
    { id: 'REQ-003', city: 'Delhi', hospital: 'Amrita Fortis & Marengo Faridabad', area: 'Faridabad', bd_type: 'Floater', bu: 'IGIV', hire_type: 'Replacement', replacement_for: 'Sonu Kumar', raised_by: 'Mahesh Anand', date: '2026-03-26', status: 'Pending Approval', notes: null },
    { id: 'REQ-004', city: 'Mumbai', hospital: 'Kokilaben Dhirubhai Ambani', area: 'Andheri West', bd_type: 'Focus', bu: 'CPM', hire_type: 'New', replacement_for: null, raised_by: 'Varun Vishwanath', date: '2026-03-28', status: 'Pending Approval', notes: 'Female candidate preferred' },
    ...
    { id: 'REQ-008', city: 'Delhi', hospital: 'Max Smart Super Specialty', area: 'Saket', bd_type: 'Focus', bu: 'CPM', hire_type: 'New', replacement_for: null, raised_by: 'Gourav Singh', date: '2026-04-01', status: 'Pending Approval', notes: null },
  ]);
}
